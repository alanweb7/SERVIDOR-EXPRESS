...
const envSchema = z.object({
  ...
  OPENCLAW_BASE_URL: z.string().url().default("https://opc.organix.ia.br"),
  OPENCLAW_RESPONSE_MODEL: z.string().default("openai-codex/gpt-5.3-codex"),
  ...
  OPENCLAW_AGENT_CONTAINER_DISCOVERY: z.enum(["true", "false"]).default("true").transform((value) => value === "true"),
  OPENCLAW_AGENT_CONTAINER_FILTER: z.string().default("openclaw_ai"),
  ...
  OPENCLAW_AGENT_TRANSPORT: z.enum(["auto", "ws", "docker"]).default("docker"),
